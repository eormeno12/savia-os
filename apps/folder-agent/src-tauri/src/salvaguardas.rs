...
use crate::dominio::{HashVerificado, Instante, Observacion, RutaRelativa};
...
impl Aparicion {
    ...
    pub fn nueva(ruta: RutaRelativa, hash: crate::dominio::HashAfirmado) -> Self {
        Self { ruta, hash }
    }
    pub fn ruta(&self) -> &RutaRelativa {
        &self.ruta
    }
    pub fn hash(&self) -> &crate::dominio::HashAfirmado {
        &self.hash
    }
}
