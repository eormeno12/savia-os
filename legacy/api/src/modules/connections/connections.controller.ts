...
import { CreateConnectionSchema, CreateGrantSchema } from '@savia-os/legacy-contracts';
import type { CreateConnectionDto, CreateGrantDto } from '@savia-os/legacy-contracts';
